              ...
              <div className="row gaper align-items-center">
                ...
                <div className="col-12 col-lg-7 col-xxl-5 offset-xxl-2">
                  <div className="text-center text-lg-start">
                    <p>
                    Choose Spearhead Creativity for innovative solutions, unmatched creativity, and a commitment to your success. Experience the difference and elevate your brand with us. Let's spearhead your creativity together.
                    </p>
                  </div>
                </div>
              </div>
